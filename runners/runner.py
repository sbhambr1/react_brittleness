...
def run_setup():
    ...
    if PILLAR_INDEX == 1 and VARIATION_INDEX == 2:
        if CATEGORY_TO_RUN == 'put':
            USE_EXAMPLES = 'examine'
        elif CATEGORY_TO_RUN == 'clean':
            USE_EXAMPLES = 'cool'
        elif CATEGORY_TO_RUN == 'heat':
            USE_EXAMPLES = 'put'
        elif CATEGORY_TO_RUN == 'cool':
            USE_EXAMPLES = 'puttwo'
        elif CATEGORY_TO_RUN == 'examine':
            USE_EXAMPLES = 'clean'
...
if __name__ == '__main__':
    ...
    exp_name = f"{pillar_idx2name[args.pillar]}_{pillar_variation_idx2name[args.pillar][args.variation-1]}"
