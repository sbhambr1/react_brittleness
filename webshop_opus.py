...
class LLM : 
    ...
    def _llm(self, prompt, stop=["\n"]):
        ...
        if LLM_MODEL in ["gpt-3.5-turbo", "gpt-4o-mini", "gpt-4o"]: 
            ...
            local_config = {"max_tokens": 100, "temperature": 0.0}
            
            INSTRUCTION = " Only provide the one action at a time. Be concise, and do not provide any extra information."
            
            prompt += INSTRUCTION
            message = self.construct_message(prompt, "user")
